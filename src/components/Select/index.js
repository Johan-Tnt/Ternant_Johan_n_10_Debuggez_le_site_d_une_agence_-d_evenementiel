...
const Select = ({
  ...
  const changeValue = (newValue) => {
    setValue(newValue);
    setCollapsed(true); // Ferme le sélecteur après la sélection
    ...
    <div className={`SelectContainer ${type}`} data-testid="select-testid">
      ...
      <div className="Select">
        ...
        <button
          ...
          onClick={(e) => {
            e.preventDefault();
            setCollapsed(!collapsed); // Inverse l'état collapsed
          }}
        >
          <Arrow />
        </button>
...
const Arrow = () => (
  <svg
    ...
    cursor="pointer"
    // Cursor pointer ajouter sur "l'icon arrow" du filtre de "SelectContainer" dans la section "Nos réalisation, Catégories"
  >
    <path
